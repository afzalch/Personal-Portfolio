...
const SecondPage = () => (
  <div>
    ...
    <div className="projects">
      ...
      <Project title="Chicago Food Inspector " img="../../ds.jpg"  tags={['app-dev', 'java']} link="https://github.com/afzalch/Chicago_Food_Inspector" description="An application that used a database to rank restaurants in Chicago based on the number and severity of food/health violations "/>  
      <Project title="Personal Portfolio" img="../../personal-site.png"  tags={['web-dev', 'gatsby', 'react']} link="https://github.com/afzalch/Personal-Portfolio" description="This website which is to describe my work experience, projects, and myself. "/> 
    </div>
    <Footer/>
  </div>
)
