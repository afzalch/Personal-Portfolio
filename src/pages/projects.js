...
const SecondPage = () => (
  <div>
    ...
    <div className="content">
      ...
      <Project title="Personal Portfolio" img="/images/ds.jpg"  tags={['web-dev', 'Gatsby', 'React']} link="https://github.com/afzalch/Personal-Portfolio" description="This website which is to describe my work experience, projects, and myself. "/>
    </div>
    <Footer/>
  </div>
)
